		...
		<div className="container mx-auto p-8 space-y-8">
			...
			<div className="mt-8 p-4 border rounded-lg bg-muted/50">
				...
				<ul className="space-y-1 text-sm">
					<li>
						✅ <strong>模式切换位置</strong>: 移到输入框上方，右对齐显示
					</li>
					<li>
						✅ <strong>RGB标签位置</strong>: 从输入框上方移到前方，垂直排列
					</li>
					<li>
						✅ <strong>RGB布局</strong>: 每个输入框独占一行，标签在左侧
					</li>
					<li>
						✅ <strong>标签宽度</strong>: 固定宽度 w-3，保持对齐
					</li>
					<li>
						✅ <strong>输入框</strong>: 使用 flex-1 占据剩余空间
					</li>
					<li>
						✅ <strong>垂直空间</strong>: 更好地利用垂直空间
					</li>
				</ul>
			</div>
