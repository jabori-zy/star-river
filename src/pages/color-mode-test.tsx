...
import { ColorPicker, ColorModeToggle } from "@/components/color-picker";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="font-mono text-lg bg-muted p-2 rounded">{displayValue}</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1 text-sm">
              <div><strong>HEX:</strong> <code>{formatColorByMode(color, 'hex')}</code></div>
              <div><strong>RGB:</strong> <code>{formatColorByMode(color, 'rgb')}</code></div>
            </div>
          </div>
        </div>
      </div>
