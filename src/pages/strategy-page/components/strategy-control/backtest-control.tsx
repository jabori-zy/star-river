...
import type { BacktestControlProps } from "./type";
...
const BacktestControl: React.FC<BacktestControlProps> = ({
					...
					<ButtonGroup>
						...
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<Button variant="secondary" size="sm" className="!pl-2">
									<ChevronDown />
								</Button>
							</DropdownMenuTrigger>
							<DropdownMenuContent align="end" className="">
								...
								<DropdownMenuItem onClick={onStopBacktest}>
									...
									<span className="text-red-500">
										{t("desktop.strategyWorkflowPage.stopStrategy")}
									</span>
								</DropdownMenuItem>
							</DropdownMenuContent>
						</DropdownMenu>
			...
			case BacktestStrategyRunState.Error:
				return (
					...
					>
						...
						<span className="text-red-500">
							{t("desktop.strategyWorkflowPage.error")}
						</span>
					</Button>
				);
			default:
	...
	return getControlButton(strategyRunState);
};
