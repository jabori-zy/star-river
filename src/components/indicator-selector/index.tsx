...
import { BacktestKlineKey, BacktestIndicatorKey, Key } from "@/types/symbol-key";
...
export default function IndicatorSelector({ 
        ...
        Object.entries(keys).forEach(([key, value]) => {
            if (key.startsWith("backtest_indicator|")) {
                ...
                if (
                    ...
                    const configDisplay = getIndicatorConfigDisplay(indicatorData.indicatorConfig);
    ...
    // 获取选中的选项
    const selectedOption = selectedIndicatorKey ? availableIndicatorOptions.find(option => option.key === selectedIndicatorKey) : undefined;
