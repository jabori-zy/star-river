...
export default function DatePickerWithInput({ 
  ...
  const getCalendarDate = (date: Date | undefined): CalendarDate | undefined => {
  ...
  const typedHandleDateChange = handleDateChange as unknown as DatePickerOnChangeType;
  ...
  const typedCalendarSelect = handleCalendarSelect as unknown as CalendarOnChangeType;
