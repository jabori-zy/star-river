...
import { IndicatorNodeData, IndicatorNodeLiveConfig } from "@/types/node/indicator-node";
...
const LiveModeShow: React.FC<LiveModeShowProps> = ({ data }) => {
    const { exchange, symbol, interval, selectedIndicators } = data.liveConfig as IndicatorNodeLiveConfig;
