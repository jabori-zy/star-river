import { PositionOperation, PositionOperationConfig } from "@/types/node/position-management-node";
...
export const getOperationDescription = (operationConfig: {
    ...
    const operationLabel = getPositionOperationLabel(operationConfig.positionOperation);
...
// 获取操作配置的状态标签
export const getOperationStatusLabel = (config: PositionOperationConfig): string => {
