...
const OperationConfigDialog: React.FC<OperationConfigDialogProps> = ({
	...
	// 获取操作类型的中文名称
	const getOperationTypeLabel = useCallback((type: PositionOperation) => {
		const labels = {
	...
	const generateOperationName = useCallback(
		...
		[existingConfigs.length, getOperationTypeLabel],
	);
	...
	}, [isOpen, isEditing, editingConfig, generateOperationName, resetForm]);
