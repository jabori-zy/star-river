...
const OperationConfigDialog: React.FC<OperationConfigDialogProps> = ({
    ...
    const [operationType, setOperationType] = React.useState<PositionOperation>(PositionOperation.UPDATE);
    ...
    // 生成默认操作名称
    const generateOperationName = useCallback((type: PositionOperation) => {
    ...
    }, [isOpen, isEditing, editingConfig, existingConfigs.length, generateOperationName]);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[424px]">
                <DialogHeader>
                    <DialogTitle>{isEditing ? '编辑仓位操作' : '添加仓位操作'}</DialogTitle>
                    <DialogDescription>
