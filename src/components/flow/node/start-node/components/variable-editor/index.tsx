...
const VariableDialog = ({ 
    ...
    const [variableType, setVariableType] = useState<StrategyVariableType>(StrategyVariableType.NUMBER);
...
// 主变量编辑器组件
const VariableEditor = ({ variables, onVariablesChange }: VariableEditorProps) => {
