...
import { PercentSquare, Wallet, Play } from "lucide-react";
...
// 回测策略设置
const BacktestStrategySetting: React.FC<BacktestStrategySettingProps> = ({ initialBalance, setInitialBalance, updateInitialBalance, leverage, setLeverage, updateLeverage, feeRate, setFeeRate, updateFeeRate, playSpeed, setPlaySpeed, updatePlaySpeed }) => {
    return (
