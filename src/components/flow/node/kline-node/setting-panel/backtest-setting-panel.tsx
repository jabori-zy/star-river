        ...
        <div className="space-y-4">
            {backtestDataSource === BacktestDataSource.EXCHANGE ? (
                ...
                <AccountSelector
                    ...
                    selectedAccount={backtestConfig?.exchangeModeConfig?.selectedAccount || null}
                    onAccountChange={handleDataSourceChange}
                />
                <SymbolSelector
                selectedSymbols={backtestConfig?.exchangeModeConfig?.selectedSymbols || []}
                onSymbolsChange={updateSelectedSymbols}
                selectedDataSource={backtestConfig?.exchangeModeConfig?.selectedAccount}
            />
