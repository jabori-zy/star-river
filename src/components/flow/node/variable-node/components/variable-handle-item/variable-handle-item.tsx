...
import { getVariableLabel, formatSymbolDisplay, getTimerConfigDisplay } from "./utils";
...
export function VariableHandleItem({ id, variableConfig }: VariableHandleItemProps) {
    return (
        <div className="relative">
            ...
            <div className="flex flex-col justify-between px-2 py-2 bg-gray-100 rounded-md relative">
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    {variableConfig.getVariableType === GetVariableType.TIMER && variableConfig.timerConfig && (
                        <>
                            <span>•</span>
