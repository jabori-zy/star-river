import { StrategySysVariable, type VariableConfig } from "@/types/node/variable-node";
 ...
 * 生成默认变量名称
 */
export const generateVariableName = (variableType: string, existingConfigsLength: number): string => {
