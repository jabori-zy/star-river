...
const AccountSelector: React.FC<AccountSelectorProps> = ({
    ...
    // 开始节点的回测配置
    const { backtestConfig: startNodeBacktestConfig, liveConfig: startNodeLiveConfig} = useStartNodeDataStore();
    ...
    }, [selectedAccount, accountList, tradeMode, startNodeBacktestConfig, startNodeLiveConfig])
