 ...
 * 切换不同的tab，展示不同的内容
 */
const TradeModeSwitcher: React.FC<TradeModeSwitcherProps> = ({ settingPanel, id, data }) => { 
    const { tradingMode } = useTradingModeStore();


    
    // 渲染设置面板的辅助函数
    const renderSettingPanel = (panel: React.ComponentType<SettingProps> | React.ReactNode) => {
