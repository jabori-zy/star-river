...
export class TradeAnnotation extends CustomAnnotation {
    ...
    public constructor(
        ...
        console.log("TradeAnnotation constructor", timeStamp, isBuy, quantity, tradePrice, markerPrice, change);
        ...
        // 订阅悬停事件
        this.hovered.subscribe((data) => this.onHover(data as AnnotationHoverEventArgs));
    }
...
const createPriceTextAnnotation = (x1: number, y1: number, x2: number, isBuy: boolean, quantity: number, price: number, change: number, viewRect: Rect) => {
...
const createPriceTextAnnotation2 = (x1: number, y1: number, x2: number, isBuy: boolean, quantity: number, price: number, change: number, viewRect: Rect) => {
