...
import { virtualTransactionColumns } from "./columns";

interface BacktestTransactionTableProps {
...
// 交易明细表
export function BacktestTransactionTable({
	data,
	title = "交易明细",
	showTitle = true,
	...
	const table = useReactTable({
		data: data || [],
		columns: virtualTransactionColumns,
		state: {
			sorting,
			columnFilters,
			rowSelection,
						...
						<Table className="w-full table-fixed">
							...
							<TableBody>
								{table.getRowModel().rows?.length ? (
									...
									<TableRow>
										<TableCell
											colSpan={virtualTransactionColumns.length}
...
export default BacktestTransactionTable;