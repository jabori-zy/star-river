 ...
 */
export function useStopBacktestStrategy(
	options?: UseStopBacktestStrategyOptions,
) {
	const { meta, onSuccess, onError, onSettled } = options || {};

	return useMutation({
		// Mutation function
		mutationFn: (params: StopBacktestStrategyRequest) =>
			stopBacktestStrategyApi(params),
