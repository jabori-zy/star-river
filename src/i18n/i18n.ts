...
// 构建语言资源的函数
const buildLanguageResource = (modules: Record<string, Record<string, any>>) => ({
    translation: {
        ...Object.values(modules).reduce((acc, module) => ({ ...acc, ...module }), {}),
    },
});

// 构建所有语言资源
const resources = Object.entries(languageModules).reduce((acc, [lang, modules]) => {
