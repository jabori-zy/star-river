		...
		seriesConfigs: [
			{
				...
				color: "#FF6B6B",
				strokeThickness: 2,
				indicatorValueKey: "sma" as keyof IndicatorValue,
			},
		],
	},
		...
		seriesConfigs: [
			{
				...
				color: "#4ECDC4",
				strokeThickness: 2,
				indicatorValueKey: "ema" as keyof IndicatorValue,
			},
		],
	},
		...
		seriesConfigs: [
			{
				...
				color: "#FF6B6B",
				strokeThickness: 1,
				indicatorValueKey: "upper" as keyof IndicatorValue,
			},
			{
				name: "中轨",
				type: SeriesType.LINE,
				color: "#4ECDC4",
				strokeThickness: 2,
				indicatorValueKey: "middle" as keyof IndicatorValue,
			},
			{
				name: "下轨",
				type: SeriesType.LINE,
				color: "#FF6B6B",
				strokeThickness: 1,
				indicatorValueKey: "lower" as keyof IndicatorValue,
			},
		],
	},
...
// 从缓存键解析指标类型的工具函数
export function parseIndicatorTypeFromCacheKey(
	cacheKey: string,
): IndicatorType | null {
