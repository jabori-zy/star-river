...
export const MACDEXTConfig: IndicatorConfig<MACDEXTConfigType> = {
	...
	params: {
		...
		fastMaType: {
			label: "indicator.configField.fastMaType",
			description: "Fast moving average type",
		...
		slowMaType: {
			label: "indicator.configField.slowMaType",
			description: "Slow moving average type",
			defaultValue: MAType.SMA,
			required: true,
		...
		signalMaType: {
			label: "indicator.configField.signalMaType",
			description: "Signal line moving average type",
			defaultValue: MAType.SMA,
			required: true,
