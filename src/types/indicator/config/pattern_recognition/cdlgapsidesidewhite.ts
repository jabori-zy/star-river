...
export type CDLGAPSIDESIDEWHITEConfigType = z.infer<typeof CDLGAPSIDESIDEWHITEConfigSchema>;
...
export const CDLGAPSIDESIDEWHITEConfig: IndicatorConfig<CDLGAPSIDESIDEWHITEConfigType> = {
	...
	indicatorValueConfig: {
		...
		gap_side_side_white: { label: "gap_side_side_white", value: 0, legendShowName: "gapsidewhite" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
			{
				...
				color: "#E5E5EA",
				lineWidth: 1,
				indicatorValueKey: "gap_side_side_white" as keyof IndicatorValueConfig,
			},
		],
	},
