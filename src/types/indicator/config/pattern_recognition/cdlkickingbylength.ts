...
export type CDLKICKINGBYLENGTHConfigType = z.infer<typeof CDLKICKINGBYLENGTHConfigSchema>;
...
export const CDLKICKINGBYLENGTHConfig: IndicatorConfig<CDLKICKINGBYLENGTHConfigType> = {
	...
	indicatorValueConfig: {
		...
		kicking_by_length: { label: "kicking_by_length", value: 0, legendShowName: "kickingbylength" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
