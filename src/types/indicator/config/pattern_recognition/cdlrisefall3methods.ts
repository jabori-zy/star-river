...
export type CDLRISEFALL3METHODSConfigType = z.infer<typeof CDLRISEFALL3METHODSConfigSchema>;
...
export const CDLRISEFALL3METHODSConfig: IndicatorConfig<CDLRISEFALL3METHODSConfigType> = {
	...
	indicatorValueConfig: {
		...
		rise_fall_three_methods: { label: "rise_fall_three_methods", value: 0, legendShowName: "risefall3methods" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
			{
				...
				color: "#673AB7",
				lineWidth: 1,
				indicatorValueKey: "rise_fall_three_methods" as keyof IndicatorValueConfig,
			},
		],
	},
