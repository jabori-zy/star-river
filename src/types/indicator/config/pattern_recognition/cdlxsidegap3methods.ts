...
export type CDLXSIDEGAP3METHODSConfigType = z.infer<typeof CDLXSIDEGAP3METHODSConfigSchema>;
...
export const CDLXSIDEGAP3METHODSConfig: IndicatorConfig<CDLXSIDEGAP3METHODSConfigType> = {
	...
	indicatorValueConfig: {
		...
		xside_gap_three_methods: { label: "xside_gap_three_methods", value: 0, legendShowName: "xsidegap3methods" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
			{
				...
				color: "#757575",
				lineWidth: 1,
				indicatorValueKey: "xside_gap_three_methods" as keyof IndicatorValueConfig,
			},
		],
	},
