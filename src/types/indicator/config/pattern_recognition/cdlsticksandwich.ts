...
export type CDLSTICKSANDWICHConfigType = z.infer<typeof CDLSTICKSANDWICHConfigSchema>;
...
export const CDLSTICKSANDWICHConfig: IndicatorConfig<CDLSTICKSANDWICHConfigType> = {
	...
	indicatorValueConfig: {
		...
		stick_sandwich: { label: "stick_sandwich", value: 0, legendShowName: "sticksandwich" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
