...
export type CDLUNIQUE3RIVERConfigType = z.infer<typeof CDLUNIQUE3RIVERConfigSchema>;
...
export const CDLUNIQUE3RIVERConfig: IndicatorConfig<CDLUNIQUE3RIVERConfigType> = {
	...
	indicatorValueConfig: {
		...
		unique_three_river: { label: "unique_three_river", value: 0, legendShowName: "unique3river" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
