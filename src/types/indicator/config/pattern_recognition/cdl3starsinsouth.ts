...
export type CDL3STARSINSOUTHConfigType = z.infer<typeof CDL3STARSINSOUTHConfigSchema>;
...
export const CDL3STARSINSOUTHConfig: IndicatorConfig<CDL3STARSINSOUTHConfigType> = {
	...
	indicatorValueConfig: {
		...
		three_stars_in_south: { label: "three_stars_in_south", value: 0, legendShowName: "3starssouth" },
	},
	chartConfig: {
		isInMainChart: false,
		seriesConfigs: [
			{
				...
				color: "#5856D6",
				lineWidth: 1,
				indicatorValueKey: "three_stars_in_south" as keyof IndicatorValueConfig,
			},
		],
	},
